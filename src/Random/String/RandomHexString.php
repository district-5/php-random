 ...
 */
class RandomHexString extends AbstractRandomStringWithCharacterSet
{
    /**
     ...
     */
    public static function get($length = 24)
    {
        return RandomAlphanumericString::get($length, self::HEX_CHARACTERS);
    }
}
